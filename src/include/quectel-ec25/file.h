...
QTEL_Status_t QTEL_FILE_RemoveFile(QTEL_FILE_HandlerTypeDef*, const char *filename);
...
QTEL_Status_t QTEL_FILE_Seek(QTEL_FILE_HandlerTypeDef*, int fn, uint32_t offset);
